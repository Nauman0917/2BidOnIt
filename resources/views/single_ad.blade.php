                ...
                <div class="col-sm-8 col-xs-12">
                    ...
                    <table class="table table-striped">
                        <tr>
                            ...
                            <th>@lang('app.item') @lang('app.price')</th>
                        </tr>
                        @foreach ($items as $item)
                            <tr>
                                <td width="100">
                                    @foreach ($item->lotItem->images as $img)
                                        <img src="{{ asset($img->image) }}" class="thumb-listing-table" alt="No Image"
                                            style="width: 40px; height: 40px; margin: 3px;">
                                    @endforeach
                                </td>
                                <td>{{ $item->lotItem->user->name }}</td>
                                <td>{{ $item->lotItem->item_name }}</td>
                                <td>{{ $item->lotItem->startPrice }}</td>
                            </tr>
                        @endforeach
                    ...
                    <div class="sidebar-widget">
                        ...
                        @if ($ad->category_type == 'auction')
                            <div class="widget">
                                ...
                                @if ($ad->is_bid_active())
                                    <p>{{ sprintf(trans('app.bid_deadline_info'), $ad->bid_deadline(), $ad->bid_deadline_left()) }}
                                    </p>
                                ...
                                @else
                                    ...
                                    @else
                                        <p>{{ sprintf(trans('app.bid_deadline_closed_info'), $ad->bid_deadline(), $ad->bid_deadline_left()) }}
                                        </p>
                                    @endif
                        ...
                        <div class="widget">
                            ...
                            @if ($ad->category_type == 'jobs')
                                ...
                                <p><span class="ad-info-name"><i class="fa fa-houzz"></i> @lang('app.employer')</span>
                                    <span class="ad-info-value company-name">{{ $ad->seller_name }}</span>
                                </p>
                                <p><span class="ad-info-name"><i class="fa fa-money"></i> @lang('app.salary')</span>
                                    <span class="ad-info-value">{!! themeqx_price_ng($ad->price) !!}</span>
                                </p>
                                <p><span class="ad-info-name"><i class="fa fa-refresh"></i> @lang('app.mentioned_salary_will_be')</span>
                                    <span class="ad-info-value"> @lang('app.' . $ad->job->salary_will_be) </span>
                                </p>

                                <p><span class="ad-info-name"><i class="fa fa-newspaper-o"></i> @lang('app.published_on')</span>
                                    <span class="ad-info-value">{{ $ad->created_at->format('M d, Y') }}</span>
                                </p>
                                <p><span class="ad-info-name"><i class="fa fa-building-o"></i> @lang('app.job_nature')</span>
                                    <span class="ad-info-value">@lang('app.' . $ad->job->job_nature)</span>
                                </p>
                                <p>
                                ...
                                <p><span class="ad-info-name"><i class="fa fa-briefcase"></i> @lang('app.job_validity')</span>
                                    <span class="ad-info-value">@lang('app.' . $ad->job->job_validity)</span>
                                </p>


                                <p><span class="ad-info-name"><i class="fa fa-clock-o"></i> @lang('app.application_deadline')</span>
                                    <span
                                        class="ad-info-value">{{ date('M d, Y', strtotime($ad->job->application_deadline)) }}</span>
                                </p>
                            @else
                                ...
                                @if (!empty($ad->country))
                                    <p><span class="ad-info-name"><i class="fa fa-globe"></i> @lang('app.country') </span>
                                        <span class="ad-info-value"> {!! $ad->country->country_name !!} </span>
                                    </p>
                                @endif

                                @if (!empty($ad->state))
                                    <p><span class="ad-info-name"><i class="fa fa-flag-o"></i> @lang('app.state') </span>
                                        <span class="ad-info-value"> {!! $ad->state->state_name !!} </span>
                                    </p>
                                @endif

                                @if (!empty($ad->city))
                                    <p><span class="ad-info-name"><i class="fa fa-area-chart"></i> @lang('app.city')
                                        </span> <span class="ad-info-value"> {!! $ad->city->city_name !!} </span></p>
                                @endif

                                <p><span class="ad-info-name"><i class="fa fa-map-marker"></i> @lang('app.address') </span>
                                    <span class="ad-info-value"> {!! safe_output($ad->address) !!} </span>
                                </p>

                            @endif

                            <p><span class="ad-info-name"><i class="fa fa-calendar-check-o"></i> @lang('app.posted_at')</span>
                                <span class="ad-info-value">{{ $ad->posted_date() }}</span>
                            </p>
                            <p><span class="ad-info-name"><i class="fa fa-calendar-check-o"></i> @lang('app.expired_at')</span>
                                <span class="ad-info-value">{{ $ad->expired_date() }}</span>
                            </p>

                            <div class="modern-social-share-btn-group">
                                <h4>@lang('app.share_this_ad')</h4>
                                <a href="#" class="btn btn-default share s_facebook"><i class="fa fa-facebook"></i>
                                </a>
                                <a href="#" class="btn btn-default share s_plus"><i class="fa fa-google-plus"></i>
                                </a>
                                <a href="#" class="btn btn-default share s_twitter"><i class="fa fa-twitter"></i>
                                </a>
                                <a href="#" class="btn btn-default share s_linkedin"><i class="fa fa-linkedin"></i>
                                </a>
                            </div>
                                    ...
                                    <div class="item-loop">
                                        ...
                                        <div class="post-card">
                                                ...
                                                <div class="post-card-category">
                                                    @if ($rad->sub_category)
                                                        <a class="price text-muted"
                                                            ...
                                                            {{ $rad->sub_category->category_name }}
                                                        </a>
                                                    @endif
                                                    @if ($rad->city)
                                            ...
                                            <div class="post-card-footer">
                                                <span class="post-card-price">@lang('app.starting_price')
                                                    {!! themeqx_price($rad->price) !!},</span>
                                                <span class="post-card-price">@lang('app.current_bid')
                                                    {!! themeqx_price($rad->current_bid()) !!}</span>
